...
WildDog::WildDog(string method, string special): Predator(6, method, 3, special, "Wild Dog") {
    cout << "Constructor(Copy 1): Wild Dog" << endl;
}

WildDog::WildDog(int HP, double damage, string method, string special) : Predator(HP, method, damage, special, "Wild Dog") {
